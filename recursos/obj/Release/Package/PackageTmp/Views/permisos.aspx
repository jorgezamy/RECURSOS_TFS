            ...
            <ContentTemplate>
                ...
                <asp:Table ID="tabla_permisos" runat="server" CssClass="tabla_registrar">
                    ...
                    <asp:TableRow ID="rowCausa" Visible="false">
                        ...
                        <%--<asp:TableCell>--%>
                            <asp:SqlDataSource ID="data_causas" runat="server" SelectCommand="select id_causaPermiso, descripcion from tnch_rh.dbo.permisos_causas where activo = 1" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

                        ...
                        <asp:View ID="View1" runat="server">
                            ...
                            <asp:Table runat="server" ID="tb_add_emp" ClientIDMode="Static">
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="civil_data" runat="server" SelectCommand="select id_edo_civil, desc_esp from tnch_rh.dbo.civil" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="paisNac_data" runat="server" SelectCommand="select id_pais, desc_esp from tnch.dbo.paises" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="edoNac_data" runat="server" SelectCommand="select id_estado, desc_esp from tnch.dbo.estados" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="cdNac_data" runat="server" SelectCommand="select id_ciudad, descripcion from tnch.dbo.ciudades" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                            ...
                            <asp:Table ID="tb_add_emp2" ClientIDMode="Static" runat="server"   Width="100%">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell ColumnSpan="2">
                                        <asp:SqlDataSource ID="zona_data" runat="server" SelectCommand="select id_zona_economica, zona_economica from tnch_rh.dbo.zonas" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="escolaridad_data" runat="server" SelectCommand="select id_escolaridad, desc_esp from tnch_rh.dbo.escolaridad order by id_escolaridad asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="escolaridad_documento" runat="server" SelectCommand="select * from TNCH_RH.dbo.escolaridad_documentos order by id_escolaridad_documento desc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="escolaridad_institucion" runat="server" SelectCommand="select id_escolaridad_instituciones as id, descripcion from TNCH_RH.dbo.escolaridad_instituciones order by id_escolaridad_instituciones asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
...
<%--                                        <ajaxToolkit:MaskedEditExtender ID="mask_codPos" runat="server" TargetControlID="tb_codpostDir" Mask="99999" />--%>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="Data_tallaC" runat="server" SelectCommand="select id_tallaC, desc_esp from tnch_rh.dbo.tallaC where activo = '1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                        ...
                        <asp:View ID="View4" runat="server">
                            ...
                            <asp:Table ID="tb_add_emp02" ClientIDMode="Static" runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="depto_data" runat="server" SelectCommand="select id_depto, desc_esp from tnch_rh.dbo.departamento" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="servicio_data" runat="server" SelectCommand="select id_servicio, descripcion from tnch_rh.dbo.servicios" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                        ...
                        <asp:View ID="View1_baja" runat="server">
                            ...
                            <asp:Table ID="table_Baja" ClientIDMode="Static" runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:SqlDataSource ID="data_drop_numBaja" runat="server" SelectCommand="select no_empleado from tnch_rh.dbo.empleados where fecha_baja is null order by no_empleado asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell ColumnSpan="2">
                                        <asp:SqlDataSource ID="data_cb_causa" runat="server" SelectCommand="select id_causaBaja, descripcion from tnch_rh.dbo.causaBaja where activo = 1 order by descripcion asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

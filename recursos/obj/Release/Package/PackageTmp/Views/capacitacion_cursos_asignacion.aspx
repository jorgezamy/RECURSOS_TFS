    ...
    <div id="contenedor">
        ...
        <asp:UpdatePanel ID="UpdatePanel_editarTractor" runat="server">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SQLDSCursos" runat="server" SelectCommand="select a.id_capacitacion_cursos, a.descripcion from TNCH_RH.dbo.capacitacion_cursos a where activo = 1 order by a.descripcion" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

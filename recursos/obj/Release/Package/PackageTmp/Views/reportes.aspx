                            ...
                            <asp:View ID="diaFestivo" runat="server">
                                ...
                                <asp:Table  runat="server" ClientIDMode="Static" HorizontalAlign="Center">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell>
                                            <asp:SqlDataSource ID="data_empleado" runat="server" SelectCommand="select id_tipo, desc_esp from TNCH_RH.dbo.tipo_empleado" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

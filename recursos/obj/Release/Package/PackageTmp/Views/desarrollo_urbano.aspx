            ...
            <ContentTemplate>
                ...
                <asp:Table ID="ubicacion_table" runat="server" Visible="false">
                    <asp:TableRow>
                        ...
                        <asp:TableCell>
                            <asp:SqlDataSource ID="data_pais" runat="server" SelectCommand="select id_pais, desc_esp from tnch.dbo.paises where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

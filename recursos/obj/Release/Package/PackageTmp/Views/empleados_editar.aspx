...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="contenedor_empleados_editar">
        ...
        <asp:UpdatePanel ID="UpdatePanelEditar" runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell>
                                    ...
                                    <asp:Table ID="tabla_editar" ClientIDMode="Static" runat="server">
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_depto" runat="server" SelectCommand="select id_depto, desc_esp from tnch_rh.dbo.departamento a where estatus = '1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_supervisor" runat="server" SelectCommand="select no_empleado from tnch_rh.dbo.empleados where fecha_egreso is null and fecha_baja is null and contrato = 'permanente'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
            ...
            <%--                                    <asp:SqlDataSource ID="SQLDS_Bonos" runat="server" SelectCommand="select id_bono_operador, descripcion from TNCH_RH.dbo.bonos_operador_menu where activo = '1' and id_bono_operador = '4' or id_bono_operador = '5' or id_bono_operador = '6' or id_bono_operador = '10'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>--%>
...
<%--                                                <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" 
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_zonas" runat="server" SelectCommand="select id_zona_economica, zona_economica from tnch_rh.dbo.zonas where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_paisDir" runat="server" SelectCommand="select id_pais, desc_esp from tnch.dbo.paises where activo = '1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
...
<%--                                                <asp:Label ID="tb_fecNac" runat="server" Text=""></asp:Label>--%>
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_civil" runat="server" SelectCommand="select id_edo_civil, desc_esp from tnch_rh.dbo.civil where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_escolaridad" runat="server" SelectCommand="select id_escolaridad, desc_esp from tnch_rh.dbo.escolaridad" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableCell>
                                    ...
                                    <asp:Table ID="tabla_editar_secundarios" ClientIDMode="Static" runat="server">
                                        ...
                                        <asp:TableRow>
                                            ...
                                            <asp:TableCell>
                                                <asp:SqlDataSource ID="data_servicioTipo" runat="server" SelectCommand="select id_servicio, descripcion from tnch_rh.dbo.servicios" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

            ...
            <ContentTemplate>
                ...
                <asp:Table ID="tabla_puestos" ClientIDMode="Static" runat="server">
                    <asp:TableRow>
                        ...
                        <asp:TableCell>
                            <asp:SqlDataSource ID="data_compania" runat="server" SelectCommand="select id_compania, nombreComercial from GCDM_rh.dbo.compania where estatus='1' " ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
...
<%--                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers, Custom" ValidChars="." TargetControlID="RFVeditIntegrado" />
                                ...
                                <%--<asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" SelectCommand="SELECT id_tipo, desc_esp, desc_eng FROM GCDM_RH.dbo.tipo_empleado" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" SelectCommand="SELECT turno FROM GCDM_RH.dbo.turnos WHERE estatus = '1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

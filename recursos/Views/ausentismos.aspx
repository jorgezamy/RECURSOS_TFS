<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="ausentismos.aspx.cs" Inherits="recursos.Views.ausentismos" %>
    ...
    <div id="contenedor">
        ...
        <asp:UpdatePanel ID="UpdatePanel_editarTractor" runat="server">
            <ContentTemplate>
                ...
                <asp:Label ID="titulo" ClientIDMode="Static" runat="server" Text="Ausentismos"></asp:Label>

                <asp:Table ID="tabla_ausentismos" runat="server" CssClass="tabla_registrar">
                    <asp:TableRow>
                        <asp:TableCell><asp:Label runat="server" Text="No. empleado:"></asp:Label></asp:TableCell>
                        <asp:TableCell>
                            <asp:DropDownList ID="ddlEmpleado" runat="server"  AppendDataBoundItems="true" OnSelectedIndexChanged="ddlEmpleado_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <asp:TableRow ID="rowFecha" Visible="false">
                        <asp:TableCell><asp:Label runat="server" Text="Día de ausentismo:"></asp:Label></asp:TableCell>
<%--                        <asp:TableCell><asp:TextBox ID="txtFecha" runat="server" Text="" placeholder="Fecha" TextMode="Date"></asp:TextBox></asp:TableCell>
                        ...
                        <asp:TableCell><asp:Label ID="lblAusentismo" runat="server"></asp:Label></asp:TableCell>
                    </asp:TableRow>
                ...
                <asp:Button ID="btn_guardar" runat="server" Text="Guardar" ValidationGroup="Guardar" CssClass="btn_guardarCancelar" OnClick="btn_guardar_Click" Visible="false" />

            ...
            <ContentTemplate>
                ...
                <asp:Table ID="tabla_incapacidades" runat="server" CssClass="tabla_registrar">
                    ...
                    <asp:TableRow ID="rowCausa" Visible="false">
                        ...
                        <asp:TableCell>
                            <asp:SqlDataSource ID="SQLDSCausa" runat="server" SelectCommand="select id_causa_incapacidad, descripcion from GCDM_rh.dbo.incapacidades_causa where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                    ...
                    <asp:TableRow ID="rowRiesgo" Visible="false">
                        ...
                        <asp:TableCell>
                            <asp:SqlDataSource ID="SQLDSRiesgo" runat="server" SelectCommand="select id_tipo_incapacidad, descripcion from GCDM_rh.dbo.incapacidades_tipo where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                    ...
                    <asp:TableRow ID="rowSecuela" Visible="false">
                        ...
                        <asp:TableCell>
                            <asp:SqlDataSource ID="SQLDSSecuela" runat="server" SelectCommand="select id_secuela_incapacidad, descripcion from GCDM_rh.dbo.incapacidades_secuela where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                    ...
                    <asp:TableRow ID="rowControl" Visible="false">
                        ...
                        <asp:TableCell>
                            <%--<asp:SqlDataSource ID="SQLDSControl" runat="server" SelectCommand="select id_control_incapacidad, descripcion from GCDM_rh.dbo.incapacidades_control where activo='1'" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>--%>

                            ...
                            <asp:View ID="curso" runat="server">
                                ...
                                <asp:Table ID="tableCurso" runat="server" ClientIDMode="Static">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell>
                                            <asp:SqlDataSource ID="data_cursos" runat="server" SelectCommand="select id_capacitacion_cursos, descripcion from GCDM_RH.dbo.capacitacion_cursos where activo = 1" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                            ...
                            <asp:View ID="empleado" runat="server">
                                ...
                                <asp:Table ID="tableEmpleados" runat="server" ClientIDMode="Static">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell>
                                            <asp:SqlDataSource ID="data_empleados" runat="server" SelectCommand="select no_empleado from GCDM_rh.dbo.empleados where fecha_baja is null order by no_empleado asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>

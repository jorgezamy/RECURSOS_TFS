...
{
    public partial class capacitacion_cursos : System.Web.UI.Page
    {
        ...
        protected void LoadMenuRoles()
        {
            ...
            var sp_loadRol = DbUtil.ExecuteProc("sp_recursos_capacitacion_cursos_roles_permitirAcceso",
        ...
        {
            Response.Redirect("capacitacion_cursos_asignacion.aspx");
        }
        protected void b2_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("capacitacion_cursos_planAnual.aspx");
        }

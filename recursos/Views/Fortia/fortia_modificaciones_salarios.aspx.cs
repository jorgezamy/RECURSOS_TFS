...
{
    public partial class fortia_modificaiones_salarios : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            reportes_load_modificaciones(5, "Modificaciones Salarios");
        }
        ...
        private void reportes_load_modificaciones(int opcion, string tipoReporte)
        {
            ...
            if (grid_modificaciones.Rows.Count == 0) //Si no hay cambios de salarios
            {
                redirigir();
            }

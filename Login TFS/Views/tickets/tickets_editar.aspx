                ...
                <asp:GridView ID="grid_editarTickets" runat="server"  AllowPaging="True" PageSize="4" OnPageIndexChanging="grid_editarTickets_PageIndexChanging"   AutoGenerateColumns="false" CssClass="gridtickets_editar"  ShowFooter="true" OnRowDataBound="grid_editarTickets_RowDataBound" >
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Estatus">
                            ...
                            <FooterTemplate>
                                <asp:SqlDataSource ID="data_estatus" runat="server" SelectCommand="select id_tickets_estatus, descripcion from gcdm.dbo.tickets_estatus where activo='1' and id_tickets_estatus != 1" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
                        ...
                        <asp:TemplateField HeaderText="Dirigido a:">
                            ...
                            <FooterTemplate>
                                <asp:SqlDataSource ID="data_deptos" runat="server" SelectCommand="select id_depto, desc_esp from gcdm_rh.dbo.departamento where estatus='1' order by desc_esp asc" ConnectionString="<% $ConnectionStrings:db %>"></asp:SqlDataSource>
